...
- **localhost:8081 - [travelAgency-OAuth2-client](https://github.com/sokolovskaOL/travelAgency-OAuth2-client)**
...
- GoogleTokenIntrospector (`src/main/java/sokolovska/yelizaveta/tourregistrationservice/config/GoogleTokenIntrospector.java`)
- SpringSecurityConfig (`src/main/java/sokolovska/yelizaveta/tourregistrationservice/config/SpringSecurityConfig.java`)
...
The Elasticsearch functionality is implemented in the `TourSearchService` interface (src/main/java/sokolovska/yelizaveta/tourregistrationservice/service/TourSearchService.java). 
The `TourSearchServiceImpl` class implements this interface (src/main/java/sokolovska/yelizaveta/tourregistrationservice/service/TourSearchServiceImpl.java). 
...
- Base test class (`src/test/java/sokolovska/yelizaveta/tourregistrationservice/contractVerifier/BaseContractTest.java`).
...
- API specification in `src/main/java/sokolovska/yelizaveta/tourregistrationservice/api/TourCrudApi.java`.
- Model definitions in `src/main/java/sokolovska/yelizaveta/tourregistrationservice/model/TourDto.java`.
